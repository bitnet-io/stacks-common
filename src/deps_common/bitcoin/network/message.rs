...
mod test {
    ...
    fn serialize_verack_test() {
        assert_eq!(
            ...
            .ok(),
            Some(vec![
                0xd1, 0xe1, 0xd1, 0xe1, 0x76, 0x65, 0x72, 0x61, 0x63, 0x6B, 0x00, 0x00, 0x00, 0x00,
    ...
    fn serialize_ping_test() {
        assert_eq!(
            ...
            .ok(),
            Some(vec![
                0xd1, 0xe1, 0xd1, 0xe1, 0x70, 0x69, 0x6e, 0x67, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    fn serialize_mempool_test() {
        assert_eq!(
            ...
            .ok(),
            Some(vec![
                0xd1, 0xe1, 0xd1, 0xe1, 0x6d, 0x65, 0x6d, 0x70, 0x6f, 0x6f, 0x6c, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5d, 0xf6, 0xe0, 0xe2
            ])
        );
    }
    ...
    fn serialize_getaddr_test() {
        assert_eq!(
            ...
            .ok(),
            Some(vec![
                0xd1, 0xe1, 0xd1, 0xe1, 0x67, 0x65, 0x74, 0x61, 0x64, 0x64, 0x72, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5d, 0xf6, 0xe0, 0xe2
            ])
        );
    }
